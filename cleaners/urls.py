...
from . import views
from .views import AccountCreateView, AddressCreateView, BranchCreateView, CatalystCreateView, CategoryCreateView, CustomerCreateView, CustomerEmailCreateView,  CustomerPhoneCreateView,  EmployeeCreateView, FactorCreateView, HarmfulFactorCreateView,  HelpfulFactorCreateView,  JourneyCreateView,  MessageCreateView,  MaterialCreateView, MethodCreateView, MethodChemCreateView, MethodMechCreateView, OrderCreateView,  PackageCreateView,  PollutionCreateView,  PremisesCreateView, ProblemCreateView,  ProcessCreateView,  ProductCreateView,  ReferralCreateView, RequestCreateView,  ScenarioCreateView, ScenarioOffsiteCreateView,  ScenarioOnsiteCreateView, SolutionCreateView, StageCreateView,  SymbolCreateView, TextureCreateView,  WorkflowCreateView
